...
// Measured in pixels.
var EPSILON_IMAGE = 5;
jasmine_util_1.describeWithFlags('TFJS FaceDetector ', jasmine_util_1.ALL_ENVS, function () {
    var timeout;
    beforeAll(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, detector_1.loadDetectorModel({ modelType: modelType, maxFaces: 1 })];
                    case 1:
                        detector = _a.sent();
                        input = tf.zeros([128, 128, 3]);
                        beforeTensors = tf.memory().numTensors;
                        return [4 /*yield*/, detector.detectFaces(input)];
                    case 2:
                        _a.sent();
...
jasmine_util_1.describeWithFlags('TFJS FaceDetector static image ', jasmine_util_1.BROWSER_ENVS, function () {
    var image;
    var timeout;
    function expectTFJSFaceDetector(image, modelType) {
        return __awaiter(this, void 0, void 0, function () {
            var detector, i, result, keypoints, expectedKeypoints;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, detector_1.loadDetectorModel({ modelType: modelType, maxFaces: 1 })];
                    case 1:
                        detector = _a.sent();
                        i = 0;
                        _a.label = 2;
                    case 2:
                        ...
                        return [4 /*yield*/, detector.detectFaces(image)];
                    case 3:
                        result = _a.sent();
                        expect(result.length).toBe(1);
                        keypoints = result[0].locationData.relativeKeypoints.map(function (keypoint) { return [keypoint.x * image.width, keypoint.y * image.height]; });
                        ...
                        test_util_1.expectArraysClose(keypoints, expectedKeypoints, EPSILON_IMAGE);
                        _a.label = 4;
                    case 4:
                        ++i;
                        return [3 /*break*/, 2];
    ...
    it('short range.', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectTFJSFaceDetector(image, 'short')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('full range.', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectTFJSFaceDetector(image, 'full')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTensors = tf.memory().numTensors;
                        return [4 /*yield*/, faceDetection.createDetector(faceDetection.SupportedModels.MediaPipeFaceMesh, __assign(__assign({}, TFJS_MODEL_CONFIG), { refineLandmarks: refineLandmarks }))];
                    case 1:
                        detector = _a.sent();
                        input = tf.zeros([128, 128, 3]);
                        beforeTensors = tf.memory().numTensors;
    ...
    it('throws error when runtime is not set.', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, faceDetection.createDetector(faceDetection.SupportedModels.MediaPipeFaceMesh)];
                case 1:
                    _a.sent();
...
jasmine_util_1.describeWithFlags('TFJS FaceMesh static image ', jasmine_util_1.BROWSER_ENVS, function () {
    ...
    function expectTFJSFaceMesh(image, staticImageMode, refineLandmarks, numFrames) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        model = faceDetection.SupportedModels.MediaPipeFaceMesh;
                        return [4 /*yield*/, faceDetection.createDetector(model, __assign(__assign({}, TFJS_MODEL_CONFIG), { refineLandmarks: refineLandmarks }))];
                    case 1:
                        detector = _a.sent();
    ...
    it('TFJS and Mediapipe backends match.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var model, tfjsResults, mediapipeResults, tfjsKeypoints, mediapipeKeypoints;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    model = faceDetection.SupportedModels.MediaPipeFaceMesh;
                    return [4 /*yield*/, faceDetection
