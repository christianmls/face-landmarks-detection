            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    expect(keypoints.length)
                        .toBe(refineLandmarks ? constants_1.MEDIAPIPE_FACEMESH_NUM_KEYPOINTS_WITH_IRISES :
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, faceDetection.createDetector(model, __assign(__assign({}, exports.MEDIAPIPE_MODEL_CONFIG), { refineLandmarks: refineLandmarks }))];
                    case 1:
                        detector = _a.sent();
